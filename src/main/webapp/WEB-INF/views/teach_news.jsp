		...
		<div class="details">
			...
			<div class="d_right">
				<div class="d_right_top">
					<div class="title">
						<div class="position">当前位置：<a href="index.html">首页</a> &gt; <a href="${ctx }/toTeachNews">新闻与公告</a></div>
					</div>
					<ul class="left_ul">
						<c:forEach items="${page.content }" var="teachNews">
							<li><a href="${ctx }/toTeachNewsDetail?id=${teachNews.id}">${teachNews.title }</a>
							<span class="right_time">[<fmt:formatDate value="${teachNews.datetime }" pattern="yyyy-MM-dd"/>]</span></li>
						</c:forEach>
					</ul>
