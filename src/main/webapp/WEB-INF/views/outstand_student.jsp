		...
		<div class="details">
			...
			<div class="d_right">
				<div class="d_right_top">
					<div class="title">
						<div class="position">当前位置：<a href="index.html">首页</a> &gt; <a href="${ctx }/toOutstandStudent">优秀学生</a></div>
					</div>
					<ul class="left_ul">
						<c:forEach items="${page.content }" var="outstandStudent">
							<li><a href="${ctx }/toOutstandStudentDetail?id=${outstandStudent.id}">${outstandStudent.title }</a>
							<span class="right_time"> 发布时间：<fmt:formatDate pattern="yyyy-MM-dd" value="${outstandStudent.datetime }"/> 点击次数：${outstandStudent.count }</span></li>
						</c:forEach>
					</ul>
