		...
		<div class="details">
			...
			<div class="d_right">
				<div class="d_right_top">
					<div class="title">
							<div class="position">当前位置：<a href="index.html">首页</a> &gt; <a href="${ctx }/toTeachArrange">教学安排</a></div>
					</div>
					<ul class="left_ul">
						<c:forEach items="${page.content }" var="teachArrange">
							<li><a href="${ctx }/toTeachArrangeDetail?id=${teachArrange.id}">${teachArrange.title }</a>
							<span class="right_time"> 发布时间：<fmt:formatDate pattern="yyyy-MM-dd" value="${teachArrange.datetime }"/> 点击次数：${teachArrange.count }</span></li>
						</c:forEach>
					</ul>
