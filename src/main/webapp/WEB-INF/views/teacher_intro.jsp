		...
		<div class="details">
			...
			<div class="d_right">
				<div class="d_right_top">
					<div class="title">
						<div class="position">当前位置：<a href="index.html">首页</a> &gt; <a href="${ctx }/toTeacherIntro">师资介绍</a></div>
					</div>
					<ul class="left_ul">
						<c:forEach items="${page.content }" var="teacherIntro">
							<li><a href="${ctx }/toTeacherIntroDetail?id=${teacherIntro.id}">${teacherIntro.title }</a><span class="right_time"> 发布时间：<fmt:formatDate pattern="yyyy-MM-dd" value="${teacherIntro.datetime }"/> 点击次数：${teacherIntro.count }</span></li>
						</c:forEach>
					</ul>
